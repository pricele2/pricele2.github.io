...
[Textbook by TCU prof Kyle Walker](https://walker-data.com/census-r/) 
...
Wait... did you say "draw a radius"?
...
all_hs = read_csv("~/R/pricele2.github.io/blog/census-workshop/data/all_ehs_hs_tx_locations.csv") |> 
  as_tibble() |> 
  rename(Add1 = 6) 
...
Consider: Why does it tell us `Passing 983 addresses` instead of 1267?
